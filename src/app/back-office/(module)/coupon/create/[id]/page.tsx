...
const EditCouponPage = () => {
    ...
    const {updateCoupon, loading, getAllCoupon, getSingleCoupon} = useCoupon()
    ...
    const getCoupon = async (id:any) => {
        try {
            const res:any = await getSingleCoupon(`${baseUrl}${prefix}/coupon/${id}`)
            form.reset({
                "name" : res.name,
                "code" : res.code,
                "type_discount" : res.type_discount,
                "discount" : res.discount,
                "start_date" : res.start_date,
                "end_date" : res.end_date,
                "limit_per_member" : res.limit_per_member,
                "kuota" : res.kuota,
                "type" : res.type,
    ...
    const handleSubmit = async (data: z.infer<typeof formSchema>) => {
        ...
        const res = await updateCoupon(`${prefix}/coupon`, payload)
